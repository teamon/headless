...
component.register = (Alpine2) => {
  Alpine2.data("hsAvatar", component);
};
...
component2.register = (Alpine2) => {
  Alpine2.data("hsClipboard", component2);
};
...
component3.register = (Alpine2) => {
  Alpine2.data("hsPopover", component3);
};
...
var headless_default = {
  start() {
    this.register(import_alpine.default);
    import_alpine.default.start();
  },
  register(alpine) {
    avatar_default.register(alpine);
    clipboard_default.register(alpine);
    popover_default.register(alpine);
  }
};
